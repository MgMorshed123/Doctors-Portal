      ...
      <div className="grid md:grid-cols-4 gap-6">
        {staticData.trustBadges.map((badge, index) => {
          ...
          return (
            <motion.div
              key={badge.id}
              className="bg-background-light p-6 dark:bg-primary-dark/10  rounded-lg text-center hover:shadow-md transition-shadow"
            ...
            >
              <IconComponent
                className="mx-auto mb-4 text-accent-light dark:text-text-dark"
                size={48}
              />
